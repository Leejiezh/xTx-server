...
```
xtx-core/src/main/java/com/leejie/xtx/core/generator/
...
```
xtx-core/src/main/resources/templates/
...
└── generator/       → CodeGenerator.java, DtoGenerator.java
```
...
- 直接在 IDE 中运行 `CodeGenerator.main()`
- 支持反复运行（覆盖已存在文件）
